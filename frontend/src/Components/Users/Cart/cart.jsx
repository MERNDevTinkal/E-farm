      ...
      {cartItems.length <= 0 ? (
        <div className="emptyCartDiv">
          <div className="emptyCart">
            <p className="emptyCartContentText">Your eFarm Cart is empty.</p>
                ...
                <div className="cartContentBox">
                  ...
                  <div className="cartStockDiv">
                    {product.countInStock ? (
                      <p className="cartStockText">In Stock</p>
                    ) : (
                      <p className="productScreenUnavailableText">
                        Out of Stock
                      </p>
                    )}
                  </div>
          ...
          <div className="checkoutBox">
            <p className="subTotalText">
              ...
              <span className="checkOutSubTotalPrice">
                {" "}
                Rs.{toPrice(cartItems.reduce((a, c) => a + c.price * c.qty, 0))}
              </span>
            </p>
            <button
              type="button"
